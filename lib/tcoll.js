...
tcoll.prototype._getM = function (pos, cb) {
	safe.back(cb,null,this._tdb._cloneDeep(this._mstore[pos-1]));
}

tcoll.prototype._getFS = function (pos, cb) {
	var self = this;
...
// query and options not used right now

// basis - http://mongodb.github.io/node-mongodb-native/api-generated/collection.html#distinct
// https://github.com/sergeyksv/tingodb/issues/10


tcoll.prototype.distinct = function(field, query, options, callback) {
  ...
  var map = function() {
    var ret = {
      extension: this[fieldname],
      count: 1 // We want to count number of each distinct value
    }
    emit(this[fieldname], ret);
  };

  var reduce = function(key, values) {
    var ret = {}
    ret.extension = key;
    ret.count = values.reduce(function(prev, cur) {
      return prev + cur.count;
    }, 0);
    return ret;
  }

  this.mapReduce(map, reduce, {
    out: { inline: 1},
